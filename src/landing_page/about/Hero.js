...
function Hero() {
  return (
    <div className="container p-5">
      ...
      <div className="row p-5 mt-5 border-top text-muted fs-5" style={{lineHeight:"1.8", marginBottom:"15px"}} >
        <div className="col-6 p-5" style={{display:"block", fontSize:"1.2rem"}}>
          <p>
